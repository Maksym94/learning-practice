...
/**
 * @author Maximka
 * This servlet return approved page when login and password is right. If user try to go on 
 * this page directly, he will be forward to login page. Only GET method is uses. 
 *
 */
