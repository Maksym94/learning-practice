...
<%-- 	<%!boolean islogIn; String login = "";%>
	...
	<%
		/* if (request.getSession().getAttribute("isLogIn") != null) {
			islogIn = (boolean) request.getSession()
		...
		if (islogIn
				&& request.getSession().getAttribute("currentLogin") != null) {
	%>
	<div align="center">

		<p>
			Login as,
			<%=login = (String) request.getSession()
						.getAttribute("currentLogin").toString()%></p>
		<a href="/SecondWeb/index.jsp?action=logout">Logout</a><br> <a
			href="/SecondWeb/index.jsp?action=approved">Account information</a><br>
		<br> <img src="/SecondWeb/Images/Loginbank.jpg" width="458"
			height="283">
